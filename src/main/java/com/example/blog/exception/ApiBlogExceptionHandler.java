...
public class ApiBlogExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {EntityInBlogCannotBeDeletedException.class})
    public ResponseEntity<Object> handleApiEntityCannotBeDeletedException(EntityInBlogCannotBeDeletedException e) {
        return new ResponseEntity<>(new ApiException(e.getMessage()), HttpStatus.BAD_REQUEST);
    }
